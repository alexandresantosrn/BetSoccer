...
public class Team {
	...
	public void setOver15total(int over15total) {
		this.over15total = over15total;
	}

	public int getOver25total() {
		return over25total;
	}

	public void setOver25total(int over25total) {
		this.over25total = over25total;
	}

	public int getOver15home() {
		return over15home;
	}

	public void setOver15home(int over15home) {
		this.over15home = over15home;
	}

	public int getOver15away() {
		return over15away;
	}

	public void setOver15away(int over15away) {
		this.over15away = over15away;
	}

	public int getOver25home() {
		return over25home;
	}

	public void setOver25home(int over25home) {
		this.over25home = over25home;
	}

	public int getOver25away() {
		return over25away;
	}
